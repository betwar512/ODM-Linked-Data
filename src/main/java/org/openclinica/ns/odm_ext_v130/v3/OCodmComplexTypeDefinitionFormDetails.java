...
public class OCodmComplexTypeDefinitionFormDetails {
    ...
    @XmlElement(name = "SectionDetailsDefinition", required = true)
    protected List<OCodmComplexTypeDefinitionSectionDetailsDefinition> sectionDetailsDefinition;
    ...
    /**
     * Gets the value of the sectionDetailsDefinition property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the sectionDetailsDefinition property.
     * 
     * <p>
     ...
     * {@link OCodmComplexTypeDefinitionSectionDetailsDefinition }
     * 
     * 
     */
    public List<OCodmComplexTypeDefinitionSectionDetailsDefinition> getSectionDetailsDefinition() {
        if (sectionDetailsDefinition == null) {
            sectionDetailsDefinition = new ArrayList<OCodmComplexTypeDefinitionSectionDetailsDefinition>();
        }
        return this.sectionDetailsDefinition;
    }
