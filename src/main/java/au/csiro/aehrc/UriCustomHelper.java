...
public class UriCustomHelper {
	...
	private static final String subjBase = "http://aehrc-ci.it.csiro.au/dataset/cardio/lcdc/id/subject/";
	...
	private static final String themeBase="aehrc-ci.it.csiro.au/dataset/cardio/lcdc/id/theme/"; 
	...
	*/
    ...
    String	themeUri=themeBase+theme;	
		return themeUri;
